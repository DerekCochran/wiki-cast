/**
 * This will compare the ASTs generated by the C and JS tokenizers.
 * It does not compare everything, because it is not all working yet.
 * The shape of what is shown is controlled by buildJsAst.js, so 
 * when we print it out, we only print out the items being compared.
 * 
*/
...
/**
 * The new JSON in addon.c appears to have fixed this issue.
